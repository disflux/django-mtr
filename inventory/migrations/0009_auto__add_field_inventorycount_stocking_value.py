...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InventoryCount.stocking_value'
        db.add_column(u'inventory_inventorycount', 'stocking_value',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InventoryCount.stocking_value'
        db.delete_column(u'inventory_inventorycount', 'stocking_value')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartValuation.applied_quantity'
        db.add_column(u'inventory_partvaluation', 'applied_quantity',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartValuation.applied_quantity'
        db.delete_column(u'inventory_partvaluation', 'applied_quantity')
    ...
    models = {
        ...
        u'inventory.inventorycount': {
            ...
            'scans': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
        ...
        u'inventory.inventorylocation': {
            'Meta': {'ordering': "['location_code']", 'object_name': 'InventoryLocation'},
        ...
        u'inventory.partvaluation': {
            'Meta': {'ordering': "['part']", 'object_name': 'PartValuation'},
            'applied_quantity': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),

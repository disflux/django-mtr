...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartValuation.stocking_cost'
        db.alter_column(u'inventory_partvaluation', 'stocking_cost', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=4))

    def backwards(self, orm):

        # Changing field 'PartValuation.stocking_cost'
        db.alter_column(u'inventory_partvaluation', 'stocking_cost', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=12, decimal_places=4))

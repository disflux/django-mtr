...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InventoryCount.counter'
        db.alter_column(u'inventory_inventorycount', 'counter_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

        # Changing field 'InventoryCount.inventory_count'
        db.alter_column(u'inventory_inventorycount', 'inventory_count', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'InventoryCount.counter'
        db.alter_column(u'inventory_inventorycount', 'counter_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

        # Changing field 'InventoryCount.inventory_count'
        db.alter_column(u'inventory_inventorycount', 'inventory_count', self.gf('django.db.models.fields.IntegerField')(default=1))
    ...
    models = {
        ...
        u'inventory.inventorycount': {
            ...
            'counter': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'count_user'", 'null': 'True', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inventory_count': ('django.db.models.fields.IntegerField', [], {'null': 'True'}),
            ...
            'stocking_value': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '4'})
        },
        ...
        u'inventory.partvaluation': {
            ...
            'stocking_cost': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '4'}),
            'uom': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True'})
        },
        u'parts.part': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PartValuation.quantity'
        db.alter_column(u'inventory_partvaluation', 'quantity', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'PartValuation.quantity'
        db.alter_column(u'inventory_partvaluation', 'quantity', self.gf('django.db.models.fields.IntegerField')(default=1))

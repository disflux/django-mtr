...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PartValuation.uom'
        db.add_column(u'inventory_partvaluation', 'uom',
                      self.gf('django.db.models.fields.CharField')(max_length=4, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PartValuation.uom'
        db.delete_column(u'inventory_partvaluation', 'uom')

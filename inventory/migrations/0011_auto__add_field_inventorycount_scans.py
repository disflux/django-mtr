...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InventoryCount.scans'
        db.add_column(u'inventory_inventorycount', 'scans',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InventoryCount.scans'
        db.delete_column(u'inventory_inventorycount', 'scans')
    ...
    models = {
        ...
        u'inventory.inventorycount': {
            ...
            'scans': ('django.db.models.fields.IntegerField', [], {'default': '0', 'null': 'True'}),

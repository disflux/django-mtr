...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InventoryLocation.count_complete'
        db.add_column(u'inventory_inventorylocation', 'count_complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'InventoryCount.auditor'
        db.add_column(u'inventory_inventorycount', 'auditor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='audit_user', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'InventoryCount.audit_timestamp'
        db.add_column(u'inventory_inventorycount', 'audit_timestamp',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InventoryLocation.count_complete'
        db.delete_column(u'inventory_inventorylocation', 'count_complete')

        # Deleting field 'InventoryCount.auditor'
        db.delete_column(u'inventory_inventorycount', 'auditor_id')

        # Deleting field 'InventoryCount.audit_timestamp'
        db.delete_column(u'inventory_inventorycount', 'audit_timestamp')
    ...
    models = {
        ...
        u'inventory.inventorycount': {
            ...
            'user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'count_user'", 'to': u"orm['auth.User']"})
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'InventoryLocation', fields ['location_code']
        db.create_unique(u'inventory_inventorylocation', ['location_code'])


    def backwards(self, orm):
        # Removing unique constraint on 'InventoryLocation', fields ['location_code']
        db.delete_unique(u'inventory_inventorylocation', ['location_code'])

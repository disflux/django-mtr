...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'reports_report', (
            ...
            ('lot_number', self.gf('django.db.models.fields.CharField')(max_length=128, unique=True, null=True, blank=True)),
            ('mfg_lot_number', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('vendor_lot_number', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('heat_number', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('vendor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['vendors.Vendor'])),
            ('part_number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parts.Part'])),
            ('description', self.gf('django.db.models.fields.TextField')()),
            ('origin_po', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('origin_wo', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ...
            ('raw_material', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'reports', ['Report'])

        # Adding M2M table for field linked_reports on 'Report'
        m2m_table_name = db.shorten_name(u'reports_report_linked_reports')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_report', models.ForeignKey(orm[u'reports.report'], null=False)),
            ('to_report', models.ForeignKey(orm[u'reports.report'], null=False))
        ))
        db.create_unique(m2m_table_name, ['from_report_id', 'to_report_id'])

        # Adding model 'ReportDocument'
        db.create_table(u'reports_reportdocument', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('primary_document', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('attachment_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True)),
            ('internal_cert', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal(u'reports', ['ReportDocument'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field linked_reports on 'Report'
        db.delete_table(db.shorten_name(u'reports_report_linked_reports'))

        # Deleting model 'ReportDocument'
        db.delete_table(u'reports_reportdocument')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Report.notes'
        db.add_column(u'reports_report', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Report.notes'
        db.delete_column(u'reports_report', 'notes')
    ...
    models = {
        ...
        u'reports.report': {
            ...
            'receiving_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 9, 0, 0)', 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
